import { Toolbar } from '@udixio/ui-react';
...
export default function ToolbarResponsiveReact() {
  return (
    <div className="w-full max-w-xs resize-x overflow-x-auto rounded-2xl border border-outline bg-surface-container-low">
      <Toolbar
        accessibleLabel="Responsive editing actions"
        actions={actions}
        responsive
        itemWidth={48}
        more={{ label: 'More editing actions' }}
      />
      <p className="px-4 pb-3 text-body-small text-on-surface-variant">
