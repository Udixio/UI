...
```jsx
  <Menu>
    <MenuItem href="/docs/components/button" value={0}>Button Component</MenuItem>
    <MenuItem href="/docs/components/card" value={1}>Card Component</MenuItem>
    <MenuItem href="https://google.com" target="_blank" value={2}>External Link</MenuItem>
    <MenuItem value={3}>No link</MenuItem>
  </Menu>
```
