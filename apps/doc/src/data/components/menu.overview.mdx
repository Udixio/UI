...
import { iContentPaste } from '@udixio/icons-rounded-400/content_paste';
import { iContentCut } from '@udixio/icons-rounded-400/content_cut';
...
<CodePreview
  ...
  <TextField
    ...
    label="Edit Actions"
  >
      <MenuItem value="cut" leadingIcon={iContentCut}>Cut</MenuItem>
      <MenuItem value="copy" leadingIcon={iContentCopy}>Copy</MenuItem>
      <MenuItem value="paste" leadingIcon={iContentPaste}>Paste</MenuItem>
      <Divider />
      <MenuItem value="all">Select All</MenuItem>
  </TextField>
`}
  scope={{ iContentCut, iContentCopy, iContentPaste }}
/>
...
<CodePreview
  ...
  code={`
  <Menu>
    <MenuItem onToggle={(activated) => console.log(activated)}>Toggle Item</MenuItem>
    <MenuItem onToggle={(activated) => console.log(activated)} activated>Activated Item</MenuItem>
  </Menu>
`}
/>
...
<div className="relative">
  <div ref={chipRef} className="inline-block">
    <Chip
      ...
      variant="filter"
      selected={open}
      trailingIcon={iKeyboardArrowDown}
