    ...
    <div className="relative w-full">
      <div className="w-full">
        <TabGroup defaultTab={0}>
          ...
          >
            <Tab label="Preview" icon={iDesktopWindows} />
            <Tab label="Colors" icon={iPalette} />
            <Tab label="Components" icon={iLayers} />
          </Tabs>
          <TabPanels>
            <TabPanel>
              <div className="p-4 flex gap-8 flex-col lg:flex-row flex-wrap justify-center relative items-center py-8">
