...
1. Compare every plugin reference with current `docs/component-authoring.md`,
   `docs/component-behavior.md`, Nx targets, package entry points, docs renderer, and representative
   mature components.
...
Run every script on a passing and failing fixture, quick-validate all skills, validate the Codex
