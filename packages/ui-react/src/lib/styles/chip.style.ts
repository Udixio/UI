...
const chipConfig: ClassNameComponent<ChipInterface> = ({
  ...
  chip: classNames(
    ' relative cursor-pointer group/chip outline-none inline-block flex  justify-center   items-center  ',
  ...
  stateLayer: classNames(
    ...
    allowShapeTransformation &&
      !disabled && {
        'group-active/chip:rounded-[12px]':
          size === 'xSmall' || size == 'small',
        'group-active/chip:rounded-[16px]': size === 'medium',
        'group-active/chip:rounded-[28px]':
