...
- **ui:** restore toolbar adapter build parity ([eccef39f](https://github.com/Udixio/UI/commit/eccef39f))
- **ui:** align search with material dimensions ([aee66244](https://github.com/Udixio/UI/commit/aee66244))

### 🧱 Updated Dependencies

- Updated @udixio/core to 0.2.2-next.11

### ❤️ Thank You

- Joël VIGREUX

## 5.1.0-next.11 (2026-09-18)

### 🧱 Updated Dependencies

- Updated @udixio/tailwind to 5.0.1-next.6
- Updated @udixio/theme to 5.0.1-next.6

## 5.1.0-next.10 (2026-09-18)

### 🧱 Updated Dependencies

- Updated @udixio/tailwind to 5.0.1-next.5
- Updated @udixio/theme to 5.0.1-next.5
- Updated @udixio/core to 0.2.2-next.9
- Updated @udixio/icons-rounded-400 to 0.2.2-next.3

## 5.1.0-next.9 (2026-09-17)

### 🧱 Updated Dependencies

- Updated @udixio/tailwind to 5.0.1-next.4
...
- Updated @udixio/core to 0.2.2-next.4

### ❤️ Thank You

- Joël VIGREUX

## 5.1.0-next.3 (2026-08-24)
...
- Updated @udixio/tailwind to 5.0.1-next.2
...
- Updated @udixio/core to 0.2.2-next.0
...
- Updated @udixio/tailwind to 5.0.0
...
- Updated @udixio/tailwind to 4.0.0
